			...
			if(that.files[0].lang=='php' && that.files.length == 1){ //php
				...
				$.post(saveURI, { lang: 'java', code:that.files[0].content, filename:that.files[0].filename, sid:sid }, function(data) {
					...
					frameShow(data)
                        ...
                        else if(that.files[0].lang=='csharp' && that.files.length == 1){ //c wwf--add
				...
				$.post(APIs.commit, params, function(data) {
					...
					if(data.result === -200) {
						if(pageInfo.next_mid==0){
							$('#J_EditorCommit').html('<p class="fail"><span class="status"></span>' + data.msg + ' <a class="operate faColor" id="J_CodeCancel">再试试</a>! <a class="operate suColor" id="J_CodeNext" href="' + data.data.next + '"> 返回课程</a></p><a href="javascript:;" class="close" id="J_Close"></a>')
						}else{
							$('#J_EditorCommit').html('<p class="fail"><span class="status"></span>' + data.msg + '，<a class="operate faColor" id="J_CodeCancel">再试试</a>！直接进入<a class="operate suColor" href="' + data.data.next + '">下一节</a></p><a href="javascript:;" class="close" id="J_Close"></a>');
						}
					}
					else if (data.result === 0) {
						if(pageInfo.next_mid==0){
							if(pageInfo.isfinished) {
								$('#J_EditorCommit').html('<p class="success"><span class="status"></span> 恭喜你,通过了本次课程 <a class="operate suColor" id="J_CodeNext" href="' + data.data.next + '">返回课程</a></p><a href="javascript:;" class="close" id="J_Close"></a>')
							}
							else {
								$('#J_EditorCommit').html('<p class="success"><span class="status"></span>代码提交成功，课程持续更新中，敬请期待！<a class="operate suColor" id="J_CodeNext" href="' + data.data.next + '">返回课程</a></p><a href="javascript:;" class="close" id="J_Close"></a>')
							}
						}else{
							tip = sucMsg[Math.floor(Math.random() * msgLength)];
							$('#J_EditorCommit').html('<p class="success"><span class="status"></span>' + tip + '<a class="operate suColor" id="J_CodeNext" href="' + data.data.next + '">下一节</a>吧。</p><a href="javascript:;" class="close" id="J_Close"></a>')
						}
					}
						...
						if(pageInfo.next_mid==0){
							...
							$('#J_EditorCommit').html('<p class="success"><span class="status"></span>代码提交成功，进入 <a class="operate suColor" id="J_CodeNext" href="' + data.data.next + '">下一节</a>！</p><a href="javascript:;" class="close" id="J_Close"></a>')
						}
					}
